  ...
  <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<?php } ?>
					<li  class="active"><a href="course.php"><i class="icon-file icon-large"></i>&nbsp;Perguruan Tinggi</a></li>
					<li><a href="subject.php"><i class="icon-list-alt icon-large"></i>&nbsp;Fakultas</a></li>
