...
?>
    <div class="container">
		...
		<div class="margin-top">
			...
			<div class="span12">
			<?php
			$student_query=mysql_query("select * from students where student_id = '$student_id'")or die(mysql_error());
			...
			<div class="span10">
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">                      
                                ...
                                <tbody>
                                 ...
                                 <?php  $user_query=mysql_query("select * from grade where student_id = '$get_id' and school_year = '$school_year'
